...
![3](/img/entropy-cross-entropy-kl/3.png)

下面看一个例子：

![4](/img/entropy-cross-entropy-kl/4.png)
...
![7](/img/entropy-cross-entropy-kl/7.png)

KL散度大于等于0，当且仅当两个概率分布相等时，等号成立。
p和q的KL散度与q和p的KL散度不一样，因此KL散度不是衡量两个概率分布之间的距离的。

![8](/img/entropy-cross-entropy-kl/8.png)
